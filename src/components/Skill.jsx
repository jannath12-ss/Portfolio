...
function Skill() {
  return (
    ...
    >
      ...
      {/* OVERLAY */}
      <div className="absolute inset-0 bg-gradient-to-br from-sky-800/50 via-white/20 to-gray-800/50"></div>

      {/* CONTENT (NO BOX) */}
      <div className="relative w-full max-w-4xl text-white space-y-8">
